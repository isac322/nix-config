...
# before opening the runtime port (stablyai/orca#16761). Keep the unattended
# server on the last verified release until upstream fixes that regression. The
# interactive laptop continues to use the upstream Homebrew cask.
{
  fetchurl,
  lib,
  stdenvNoCC,
