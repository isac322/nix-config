{
  ...
  inputs = {
    ...
    # Generated by `nix run .#update-packages`; do not edit by hand.
    llm-agents.url = "git+https://github.com/numtide/llm-agents.nix.git?rev=9032892fd4d89bdad79c858a81aae1268ad2d191&shallow=1";
    ...
    llm-agents.inputs."nixpkgs".url = "git+https://github.com/NixOS/nixpkgs.git?rev=79b35bf0bda5cd110f856aa5b5b2c5ba4460dbf5&shallow=1";
