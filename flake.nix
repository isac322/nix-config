{
  ...
  inputs = {
    ...
    # Generated by `nix run .#update-packages`; do not edit by hand.
    llm-agents.url = "git+https://github.com/numtide/llm-agents.nix.git?rev=7c0157f864d113d9f0ce324a78496de6da6e7e07&shallow=1";
    llm-agents.inputs."bun2nix".url = "git+https://github.com/Mic92/bun2nix.git?rev=5765b0614591f75ee8ba5596e81ae85c167d1071&shallow=1";
    ...
    llm-agents.inputs."nixpkgs".url = "git+https://github.com/NixOS/nixpkgs.git?rev=c80073788adf88abfdc443465311f00e7a231600&shallow=1";
