{
  ...
  inputs = {
    ...
    # Generated by `nix run .#update-packages`; do not edit by hand.
    llm-agents.url = "git+https://github.com/numtide/llm-agents.nix.git?rev=03aa73a454d7468e0a3d44faee511fa6ae7c7ded&shallow=1";
    ...
    llm-agents.inputs."nixpkgs".url = "git+https://github.com/NixOS/nixpkgs.git?rev=d54020a6ac3211e9f4201631bdf67678818c0cdf&shallow=1";
