{
  ...
  inputs = {
    ...
    # Generated by `nix run .#update-packages`; do not edit by hand.
    llm-agents.url = "git+https://github.com/numtide/llm-agents.nix.git?rev=bbb0f9a24c3a5ce918f3d8103397ce08b20300e1&shallow=1";
    ...
    llm-agents.inputs."nixpkgs".url = "git+https://github.com/NixOS/nixpkgs.git?rev=79b6d20e55596f80baa35cda2a334da8a1fbf1ea&shallow=1";
