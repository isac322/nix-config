{
  ...
  inputs = {
    ...
    # Generated by `nix run .#update-packages`; do not edit by hand.
    llm-agents.url = "git+https://github.com/numtide/llm-agents.nix.git?rev=2e9c743bc337136b0714f27dae05d575ad81f0ee&shallow=1";
    ...
    llm-agents.inputs."nixpkgs".url = "git+https://github.com/NixOS/nixpkgs.git?rev=34ca302a9572963c02e385c056be37c85ff51b77&shallow=1";
